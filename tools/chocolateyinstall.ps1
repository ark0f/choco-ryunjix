...
$url64      = 'https://github.com/Ryujinx/release-channel-master/releases/download/1.1.1336/ryujinx-1.1.1336-win_x64.zip'
$checksum64 = '7416bc82794a366027eb45686cd50a0b819f565df5244d8d0535473c0096ad30'
